...
class ConditionTypeStep extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Pilih jenis kondisi atau status yang akan sering Anda gunakan untuk mencatat riwayat logbook harian ternak.',
          ...
          Text(
            'Kondisi Spesifik Peternakan Anda?',
            style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 16),
          ),
          const SizedBox(height: 12),
          ...
          OutlinedButton.icon(
            ...
            label: const Text('Tambah Kondisi Sendiri'),
