...
class AnimalTypeStep extends StatelessWidget {
            ...
            ElevatedButton(
              onPressed: () {
                if (formKey.currentState!.validate()) {
                  ...
                  // Buat code sederhana dari label: "Kuda Poni" -> "kuda-poni"
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Pilih jenis ternak yang akan Anda kelola di peternakan ini. Anda bisa memilih lebih dari satu.',
          ...
          OutlinedButton.icon(
            ...
            label: const Text('Tambah Jenis Sendiri'),
